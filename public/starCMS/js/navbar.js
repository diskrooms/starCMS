            ...
            if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
                ...
                for (var j = 0; j < data[i].children.length; j++) {
					if(data[i].children[j].spread){
                    	ulHtml += '<li title="' + data[i].children[j].title + '" class="layui-nav-item layui-nav-itemed">';
					} else {
						ulHtml += '<li title="' + data[i].children[j].title + '" class="layui-nav-item">';
					}
					if(data[i].children[j].href !== undefined && data[i].children[j].href !== ''){
                    ...
                    ulHtml += '</a>';
						...
						if(data[i].children[j].children !== undefined && data[i].children[j].children !== null && data[i].children[j].children.length > 0){
							ulHtml += '<ul class="layui-nav-child layui-nav-child2">';
								for (var z = 0; z < data[i].children[j].children.length; z++) {
									ulHtml += '<li title="' + data[i].children[j].children[z].title + '">';
									ulHtml += '<a href="javascript:;" data-url="' + data[i].children[j].children[z].href + '">';
									if (data[i].children[j].children[z].icon !== undefined && data[i].children[j].children[z].icon !== '') {
										if (data[i].children[j].children[z].icon.indexOf('fa-') !== -1) {
											ulHtml += '<i class="fa ' + data[i].children[j].children[z].icon + '" data-icon="' + data[i].children[j].children[z].icon + '" aria-hidden="true"></i>';
										} else {
											ulHtml += '<i class="layui-icon" data-icon="' + data[i].children[j].children[z].icon + '">' + data[i].children[j].children[z].icon + '</i>';
										}
									}
									ulHtml += '<cite>' + data[i].children[j].children[z].title + '</cite>';
									ulHtml += '</a>';
									ulHtml += '</li>';
								}
							ulHtml += '</ul>';
